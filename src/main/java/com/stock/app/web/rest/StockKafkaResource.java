...
import com.stock.app.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/stock-kafka")
public class StockKafkaResource {

    private final Logger log = LoggerFactory.getLogger(StockKafkaResource.class);
/*
    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public StockKafkaResource(KafkaProperties kafkaProperties) {
